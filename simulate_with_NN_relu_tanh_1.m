...
for ct = 1:(Duration/Ts) 
     u = NN_output_relu_tanh(x_now,0,1,'NN/nn_relu_tanh_1');
...
fig_pos(3)
fig_pos(4)
text(0, 0.7, 'L=13.1', 'FontSize',18);
text(0, 0.1, 'ReLU-tanh', 'FontSize',18);
print(fig,'./Benchmarks/dubinscar_relu_tanh_1','-dpdf');
export_fig ./Benchmarks/dubinscar_relu_tanh_1.pdf