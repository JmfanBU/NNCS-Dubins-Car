...
for ct = 1:(Duration/Ts) 
     u = NN_output_relu_tanh(x_now,0,1,'NN/nn_relu_tanh_origin');
...
text(0, 0.7, 'L=244.3', 'FontSize',18);
text(0, 0.1, 'ReLU-tanh', 'FontSize',18);
print(fig,'./Benchmarks/dubinscar_relu_tanh_origin','-dpdf')
export_fig ./Benchmarks/dubinscar_relu_tanh_origin.pdf